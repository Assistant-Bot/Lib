...
export interface MemberProps extends BaseProps {
    ...
    permissions: any; // PermissionProps
    guild: any; // GuildProps
...
export interface MessageProps extends BaseProps {
    ...
    attachments: any; // Array on eris, collection on d.js
    author: UserProps;
    content: string;
    ...
    mentions: UserProps[];
    pinned: boolean;
    reactions: { [s: string]: unknown; count: number; me: boolean }; // todo: d.js
    timestamp?: number;
