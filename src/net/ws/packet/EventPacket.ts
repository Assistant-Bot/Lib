...
export type GatewayEvent =
	...
	| 'GUILD_APPLICATION_COMMANDS_DELETE'
	| 'GUILD_APPLICATION_FORM_UPDATE' // unknown structure
	| 'GUILD_APPLICATION_FORM_CREATE' // unknown structure
	| 'GUILD_APPLICATION_FORM_DELETE'
	| 'INVITE_CREATE'
	| 'INVITE_DELETE'
	| 'MESSAGE_CREATE'
	| 'MESSAGE_UPDATE'
